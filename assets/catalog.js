$(document).ready(function () {
  $(".catalog-tabs__nav-item").on("click", function (e) {
    ...
    $(".catalog-tabs__nav-item").removeClass("catalog-tabs__nav-item--active");
  ...
  if (
    ...
    const swipers = document.querySelectorAll(".furniture-gallery__box-slider");
  ...
  const aboutSlider = new Swiper(".about-slider__container", {
    ...
    pagination: {
      clickable: true,
      el: ".about-slider .swiper__pagination",
    },
    breakpoints: {
      // 320: {
      //     slidesPerView: 1,
